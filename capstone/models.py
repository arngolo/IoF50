...
class Imagery(models.Model):
    ...
    shapefile_path_shp = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/Lobito_1.shp")
    shapefile_path_dbf = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/Lobito_1.dbf")
    shapefile_path_sbn = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/Lobito_1.sbn")
    shapefile_path_shx = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/Lobito_1.shx")
    shapefile_path_sbx = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/Lobito_1.sbx")
    shapefile_path_prj = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/Lobito_1.prj")
