...
class Imagery(models.Model):
    ...
    shapefile_path_shp = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/dummy_shapefile.shp")
    shapefile_path_dbf = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/dummy_shapefile.dbf")
    shapefile_path_sbn = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/dummy_shapefile.sbn")
    shapefile_path_shx = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/dummy_shapefile.shx")
    shapefile_path_sbx = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/dummy_shapefile.sbx")
    shapefile_path_prj = models.FileField(upload_to= 'shapefiles', default=os.getcwd() + "/media/default_shapfiles/dummy_shapefile.prj")
